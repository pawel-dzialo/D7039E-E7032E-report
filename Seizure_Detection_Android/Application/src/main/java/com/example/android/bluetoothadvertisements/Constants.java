...
public class Constants {
    ...
    public static final ParcelUuid Service_UUID = ParcelUuid
            .fromString("D973F2E2-B19E-11E2-9E96-0800200C9A66");//8 12


    public static final ParcelUuid UUID_MASK = ParcelUuid.fromString("00000000-0000-0000-0000-000000000000");
