...
public class ScannerFragment extends ListFragment{
    ...
    /**
     * Stops scanning after 50 seconds.
     */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.something = new Something() {
            @Override
            public void callbackCall(BluetoothDevice device) {
                something.callbackCall(device);
            }
        };
    ...
    private List<ScanFilter> buildScanFilters() {
        ...
        //builder.setServiceUuid(Constants.Service_UUID, Constants.UUID_MASK);
        builder.setDeviceAddress("02:80:E1:00:00:AA");
