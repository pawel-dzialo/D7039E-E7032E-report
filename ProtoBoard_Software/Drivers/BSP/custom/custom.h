...
#define BUS_BSP_BUTTON_GPIO_PIN GPIO_PIN_9
...
#define USER_BUTTON_EXTI_LINE              EXTI_LINE_9
#define H_EXTI_9			  hpb_exti[BUTTON_USER]
/**
 * @}
 */
...
#define BUS_USART3_RX_GPIO_PIN GPIO_PIN_5
#define BUS_USART3_RX_GPIO_CLK_DISABLE() __HAL_RCC_GPIOC_CLK_DISABLE()
#define BUS_USART3_RX_GPIO_PORT GPIOC
#define BUS_USART3_RX_GPIO_AF GPIO_AF7_USART3
#define BUS_USART3_RX_GPIO_CLK_ENABLE() __HAL_RCC_GPIOC_CLK_ENABLE()
...
#define BUS_USART3_TX_GPIO_PORT GPIOB
#define BUS_USART3_TX_GPIO_PIN GPIO_PIN_10
